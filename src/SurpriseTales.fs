...
let (scenario: Scenario<Content, Label, CustomStatement>) =
    [
        ...
        label StartTaleAboutWizard [
            ...
            agentSay [
                p [[
                    text "Подожди! Чего-то не хватает между"
                    text "> «Это же большая тетя Совинита» - сказала Светсябитова"
                    text "и"
                    text "> Довела Совенита наших героев"
                    text "<:pepeRee:958453248019267655>"
                ]]
            ]
